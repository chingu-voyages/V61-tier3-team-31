-- Align submit_application with the apply form contract.
--
-- The user's full name belongs to profiles and is collected during
-- registration/profile editing. The apply form no longer sends fullName, so
-- the database RPC should not accept or write p_full_name.
