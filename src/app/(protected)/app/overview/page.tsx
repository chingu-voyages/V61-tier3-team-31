  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 bg-card rounded-[24px] border border-border shadow-[0_4px_20px_rgba(0,0,0,0.02)] dark:shadow-[0_4px_20px_rgba(0,0,0,0.2)] p-8 flex flex-col justify-between">
          <div className="mb-6">
        ...
        {/* Right: Deadlines */}
        <div className="lg:col-span-4 bg-card rounded-[24px] border border-border shadow-[0_4px_20px_rgba(0,0,0,0.02)] dark:shadow-[0_4px_20px_rgba(0,0,0,0.2)] p-6 flex flex-col">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
          {pipelineSteps.map((p, i) => (
            <div
              key={i}
              className="bg-card rounded-[24px] border border-border shadow-[0_4px_20px_rgba(0,0,0,0.02)] dark:shadow-[0_4px_20px_rgba(0,0,0,0.2)] p-5 flex flex-col hover:shadow-lg transition-shadow cursor-pointer"
            >
              <div className="flex items-center justify-between mb-4">
                ...
                <span
                  className={`text-[10px] font-semibold ${p.btnBg} ${p.color} px-2 py-0.5 rounded-full`}
                >
                  {p.total}
                </span>
              </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Needs Attention */}
        <div className="bg-card rounded-[24px] border border-border shadow-[0_4px_20px_rgba(0,0,0,0.02)] dark:shadow-[0_4px_20px_rgba(0,0,0,0.2)] p-6">
          <div className="flex items-center justify-between mb-5">
